...
export const eventsApi = {
  ...
  async addEventContractor(eventId: string, payload: {
    ...
    const data = await apiRequest<any>(`/events/${eventId}/contractors`, {
      ...
      body: JSON.stringify({
        ...
        member_quantity: payload.memberQuantity,
  ...
  async updateEventContractor(eventId: string, contractorId: string, payload: {
    ...
    const data = await apiRequest<any>(`/events/${eventId}/contractors/${contractorId}`, {
  ...
  async deleteEventContractor(eventId: string, contractorId: string): Promise<void> {

    await apiRequest(`/events/${eventId}/contractors/${contractorId}`, {
