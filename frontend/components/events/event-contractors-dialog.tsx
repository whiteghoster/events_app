      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Set the work period and assign contractors with their shift,
              quantity, and dates.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-3 bg-muted/50 rounded-lg border">
            <div className="space-y-1.5">
              <Label htmlFor="worksFrom" className="text-xs">
                Works From
              </Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="worksTo" className="text-xs">
                Works To
              </Label>
          ...
          {entries.length === 0 ? (
            <p className="text-sm text-muted-foreground py-6 text-center border border-dashed rounded-lg">
              No contractors assigned. Click &quot;Add Contractor&quot; to
              start.
            </p>
          ) : (
                ...
                >
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateEntry(index, {
                          shift: value as typeof entry.shift,
                        })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="flex items-center border rounded-md overflow-hidden">
                      <Button
                        ...
                        onClick={() =>
                          updateEntry(index, {
                            memberQuantity: Math.max(
                              1,
                              (entry.memberQuantity || 1) - 1
                            ),
                          })
                        }
                      >
