...
export function SidebarRegisterForm({ collapsed }: SidebarRegisterFormProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="right" className="w-[400px] sm:w-[450px] bg-card border-l border-border flex flex-col p-0">
        <SheetHeader className="p-6 border-b border-border bg-secondary/30">
          ...
          <SheetTitle className="text-2xl font-serif">Quick Invite</SheetTitle>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="staff_member">Staff Member (Field)</SelectItem>
