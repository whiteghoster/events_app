...
import { Plus, Pencil, MoreVertical, RotateCcw, Ban, X, Loader2 } from 'lucide-react'
...
export default function CatalogPage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 mx-4">
        {/* Categories Sidebar */}
        <div className="w-full lg:w-64 shrink-0 order-1">
          <div className="skeu-card bg-card rounded-xl border border-border">
            ...
            <div className="p-2">
              {categories.length > 0 ? (
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? 'bg-gradient-to-r from-sidebar-accent to-sidebar-accent/50 border-l-2 border-l-primary shadow-sm'
                          : 'hover:bg-gradient-to-r hover:from-secondary hover:to-secondary/50'
                      )}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-muted-foreground bg-gradient-to-r from-secondary to-secondary/80 px-2 py-0.5 rounded-full shadow-sm">
                          {productCount}
                        </span>
                        {hasActiveProducts && (
                      ...
                      {canManage && (
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="skeu-card">
                ...
                <div className="p-8 text-center bg-gradient-to-br from-secondary/30 to-secondary/20 rounded-lg border border-dashed border-border mx-2 my-2">
